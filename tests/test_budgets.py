...
from src.budgets import build_budgets_metadata, generate_training_budgets
...
def test_budget_metadata_subsets_are_nested_and_deterministic() -> None:
    ...
    metadata_a = build_budgets_metadata(train_ids=train_ids, split_seed=42)
    metadata_b = build_budgets_metadata(train_ids=train_ids, split_seed=42)
